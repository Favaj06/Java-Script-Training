...
function InternLoader() {
  ...
  return (
    <ul>
      ...
      {/* Data fetching is placed inside useEffect so it runs after the component
          renders. If it were placed directly inside the component body, it
          would execute on every render, causing repeated API calls and
