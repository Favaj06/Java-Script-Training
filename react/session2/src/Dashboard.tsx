...
// Array.map() creates one InternCard component for each intern.
// The unique 'id' is used as the React key for efficient rendering.
// filter() counts the number of present interns.
// reduce() adds all scores together to calculate the average score.